...
const routes = [
  ...
  },
  {
    path: "/read/:id",
    name: "read",
    component: () => import("../components/parts/Read.vue")
  },
  // authentication
  {
    path: "/login",
  ...
  },
  {
    path: "/login-help",
    name: "LoginHelp",
    component: () => import("../components/authentication/LoginHelp.vue")
  },
  {
    path: "/reset",
    name: "Reset",
  ...
  },
  {
    path: "/confirm",
    name: "Confirm",
    component: () => import("../components/authentication/Confirm.vue")
  },
  // private
  {
    path: "/dashboard",
